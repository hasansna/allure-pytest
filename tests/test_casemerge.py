...
def test_if_substeps_are_correct(report_for):
    ...
    assert report.xpath('.//a[text()="test_passed[1]"]')[0].getparent().find('steps/step/title').text == 'Step1'
    assert report.xpath('.//a[text()="test_passed[1]"]')[0].getparent().find('steps/steps/steps/title').text == 'Step2'
...
def test_if_attachments_are_correct(report_for):
    ...
    assert report.xpath('.//a[text()="test_passed[1]"]')[0].getparent().find('attachments/attachment').attrib['title'] == 'Attachment'
